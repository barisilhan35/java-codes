...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hamburger hamburger = new Hamburger("Basic", "Sausage",
                3.56, "White");
        double price = hamburger.totalPriceHamburger();
        hamburger.addHamburgerAddition1("Tomato", 0.27);
        hamburger.addHamburgerAddition2("Lettuce", 0.75);
        hamburger.addHamburgerAddition3("Cheese", 1.13);
        //price = hamburger.totalPriceHamburger();
        ...
        healthyBurger.addHamburgerAddition1("tomato",3.14);
        healthyBurger.addHealthAddition1("veggy",4);
        healthyBurger.totalPriceHamburger();
        System.out.println("Total Healthy Burger price is  "
                + healthyBurger.totalPriceHamburger());

        DeluxeBurger dburger =new DeluxeBurger();
        dburger.addHamburgerAddition3("Should not do this", 50.53);
        dburger.addHamburgerAddition4("",3);
        dburger.totalPriceHamburger();
    }
}
